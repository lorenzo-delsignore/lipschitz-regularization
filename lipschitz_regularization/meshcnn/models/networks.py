...
from lipschitz_regularization.meshcnn.models.layers.mesh_conv import MeshConv
import torch.nn.functional as F
from lipschitz_regularization.meshcnn.models.layers.mesh_pool import MeshPool
from lipschitz_regularization.meshcnn.models.layers.mesh_unpool import MeshUnpool
...
class MeshEncoderDecoder(nn.Module):
    ...
    def forward(self, x, meshes):
        encoder_features, before_pool = self.encoder((x, meshes))
        fe = self.decoder((encoder_features, meshes), before_pool)
        return fe, encoder_features
